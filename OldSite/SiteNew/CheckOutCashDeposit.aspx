<%@ Page Title="Check Out Cash Deposit - LU Computers" Language="C#" MasterPageFile="~/SiteNoForm.master" AutoEventWireup="true" CodeFile="CheckOutCashDeposit.aspx.cs" Inherits="CheckOutCashDeposit" %>
        ...
        <div class="container" style="background: #74C774; padding: 0px;">
            <div style="padding-bottom: 0px; background: #74C774; border: 0px solid red; padding: 15px 15px 0px 15px;">
                <ul class="list-inline" style="margin-left: 2em;">
                    ...
                    <li>
                        <div style="font-size: 20px; color: White;">PAYING BY CASH DEPOSIT</div>
                    </li>
                </ul>
            </div>
            <div style="background-color: White; margin: 0 3em 3em 3em; padding: 5px;">
                ...
                <div class="note" style="padding: 2em 2em 0 2em;">
                    <p>
                        If you are in Canada, you can make cash deposit to the nearest TD Canada Trust branch. We will send you our account number right after you plalce your order. 
                    </p>
                    <p>Please ask the teller to add your name on your transaction to show on LU Computers' banking screen. Otherwise we will be difficult to identify your payment. Please contact us right after you have made your deposit. </p>

                </div>
                <hr size="1" />
                <p style="padding: 0em 2em 0 2em;">NOTE: Most items on this form are required.</p>
                <fieldset style='width: 80%; margin: 0 auto;'>
                    <input type="hidden" name="cmd" value="saveCashDeposit" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="firstName" id="firstName" value="<%= FirstName %>" placeholder=""></div>
                        <div class="col-sm-3 control-label" style="text-align: left;"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Last Name:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="lastName" id="lastName" value="<%= LastName %>" placeholder=""></div>
                        <div class="col-sm-3 control-label" style="text-align: left;"></div>
                    </div>
                    <div class="form-group">
