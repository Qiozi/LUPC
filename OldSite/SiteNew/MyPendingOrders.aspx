<%@ Page Title="My Pending Order - LU Computers" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyPendingOrders.aspx.cs" Inherits="MyPendingOrders" %>
    ...
    <div class="container" style="background: #74C774; padding: 0px;">
        ...
        <div style="background: white; margin: -1em 3em 3em 3em; padding: 1em;" role="navigation">
            ...
            <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="MyModifyPwd.aspx">Modify Password</a></li>
