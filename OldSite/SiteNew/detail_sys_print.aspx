    ...
    <div style="background: white;">
        <div class="" style="background: #ccc; padding: 1em; margin-top: -50px;">
            <a class="navbar-brand" style="margin-top: -29px;">
                <img src="<%= string.Concat(LU.BLL.Config.ResHost,"images/logo1.png") %>" /></a>
            <span class="glyphicon glyphicon-phone-alt"></span>1866.999.7828&nbsp;&nbsp;416.446.7743  
        </div>
        <div class="container" style="background: white;">
            <div style="height: 5px;"></div>
            <div class="row" id='sysLogoArea' style="margin-top:97px;">
                <div class="col-sm-6">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    <script>
        $(document).ready(function () {
            ...
            $('.topNavBox').remove();
            $('.view-ui-page-main1').css({ 'margin-top': '-130px' });
            $('.searchBox').remove();
            $('a[title="Shopping Cart"]').remove();
        });
    </script>
</asp:Content>
