<%@ Page Title="Contact US - LU Computers" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="bContactUs.aspx.cs" Inherits="bContactUs" %>
        ...
        <div class="page-main">
            ...
            <div class="media">
                <div class="media-body">
                    <p>
                        For questions, comments or suggestions, please feel free to contact us by telephone or email.
                    </p>
                ...
                <div class="media-right">
                    <img class="" src="<%= string.Concat(setting.ImgHost, "soft_img/app/canada_map.gif") %>" alt="...">
                    <img class="" src="<%= string.Concat(setting.ImgHost, "soft_img/app/USA_map.gif") %>" alt="...">
                </div>
            </div>
            ...
            <div class="media">
                ...
                <div class="media-right">
                    <img class="" src="<%= string.Concat(setting.ImgHost, "soft_img/app/map2.gif")%>" alt="...">
                </div>
            </div>
            ...
            <div>
                <p>
                    <strong>From 404 (Don Valley Parkway):</strong> Please change to 401 West and take first exit to Leslie Street south. Please pass the second light after you turn onto Leslie Street. About 150M further a yellow sign of 1875 is on your left hand side. 1875 Leslie Street, Unit 24 is LU Computers.
                </p>
                ...
                <p>
                    <strong>Local driving or by bus:</strong> LU Computers is located at northeast intersection of York Mills Road and Leslie Street. About 150M away from York Mills Road is a yellow address sign of 1875 next to Esso. 1875 Leslie Street, Unit 24 is LU Computers.
