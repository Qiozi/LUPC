<%@ Page Title="LU Computers System Detail" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    ...
    <div>
        <div class="container" style="background: white;">
            ...
            <div class="page-header">
                <h3>
                    <asp:Literal runat="server" ID="ltTitle"></asp:Literal></h3>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6 priceArea">
                    ...
                    <p>
                        <a class="btn btn-default hide"><span class="glyphicon glyphicon-envelope"></span>&nbsp;Email to
                            Me</a>
                    ...
                    <a class="btn btn-default btn-danger" id="A2" href="detail_sys_customize.aspx?sku=<%= ReqSKU %>">
                        <span class="glyphicon glyphicon-cog"></span>&nbsp;Customize It</a> <a class="btn btn-default btn-danger"
