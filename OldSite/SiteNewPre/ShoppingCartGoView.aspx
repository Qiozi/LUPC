<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShoppingCartGoView.aspx.cs" Inherits="ShoppingCartGoView" %>
    ...
    <div class="container" style="background: #74C774; padding: 0px;">
        ...
        <div style="background-color: White; margin: -1em 3em 3em 3em; padding: 10px;">
            ...
            <div class="row">
                ...
                <div class="col-md-3"><%= CurrOrderCode %></div>
                <div class="col-md-2">Customer Number:</div>
                <div class="col-md-3"><%= CustomerSerialNo %></div>
                <div class="col-md-1"></div>
            </div>
            <div class="row">
                <div class="col-md-1"></div>
