<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyOrderView.aspx.cs" Inherits="MyOrderView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="background-color: White; margin: -1em 3em 3em 3em; padding: 10px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><%= CurrOrderCode %></div>
            <div class="col-sm-2">Customer#:</div>
            <div class="col-sm-4"><%= CustomerSerialNo %></div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3"><%= CustomerName %></div>
