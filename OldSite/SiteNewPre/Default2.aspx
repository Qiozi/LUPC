<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2.aspx.cs" MasterPageFile="~/Site.master" Inherits="Default2" %>
            ...
            <div class="row mg-t">
                ...
                <div class="col-md-2">
                    <div class="" id="leftCateList" data-spy="affix" data-offset-top="860" data-offset-bottom="200">
                        <ul class="nav">
                            <li><a href='#prodListArea' data-toggle="tooltip" data-placement="left" title="ALL Category">System PC</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$.getJSON("/Computer/all_cate.json?", function (data) {
            //    var cont = data; /// eval('(' + data + ')');

            //    //var contResult = "<div class=\"row \" >";
            //    //$.each(cont, function (i, item) {
            //    //    if (item.ID != 2 && item.ID != 211) {
            //    //        contResult += "<div class=\"col-xs-6 col-md-2 cateArea\"><h5>" + item.Name + "</h5>";
            //    //        var subContResult = "";
            //    //        $.each(item.SubList, function (n, subitem) {
            //    //            if (subitem.Name != undefined)
            //    //                subContResult += "<div class=\"\"><small><a href='" + getCateHref(subitem.ID, subitem.PageType == 0) + "'>" + subitem.Name + "</a></small></div>";
            //    //        });
            //    //        contResult += subContResult + "</div>";
            //    //    }
            //    //    else if (item.ID == 2) {
            //    //        contResult += "<div class=\"col-xm-6 col-md-4 cateArea\"><h5>" + item.Name + "</h5>";
            //    //        var subContResult = "";
            //    //        $.each(item.SubList, function (n, subitem) {
            //    //            if (subitem.Name != undefined)
            //    //                subContResult += "<div class=\"col-xm-6 col-md-6\" style='padding-left:0px;'><small class='nav-hover'><a href='" + getCateHref(subitem.ID, subitem.PageType == 0) + "'>" + subitem.Name + "</a></small></div>";
            //    //        });
            //    //        contResult += subContResult + "</div>";
            //    //    }
