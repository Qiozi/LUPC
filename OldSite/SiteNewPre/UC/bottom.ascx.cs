...
public partial class UC_bottom : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.Url.ToString().IndexOf("localhost") == -1)
        {
           ...
           // GodaddySSL = @"<script async type="text/javascript"      src="https://seal.godaddy.com/getSeal?sealID=m1rXgddaupGKJemjFI0QslvJUzAlm8xCPKQIS8YF5EQySbD7W50Rjths2lK"></script></span>"
        }
    }
}