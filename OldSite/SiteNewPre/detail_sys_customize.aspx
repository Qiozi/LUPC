        ...
        <div class="row">
            <div class="col-md-5 text-center" style="background: white;">
                <div class="text-center" style="border: 1px solid #ccc; margin: 1em -1em 0 0;">
                    <img id="sysCaseLogo" src="images/loaderc.gif" width="400" alt='...' />
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
                    <div style="padding: 1em;">
                        <ul class="list-group ">
                            ...
                            <li class="list-group-item">Special Cash Price<span class="badge regularPrice"></span></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function changeCaseLogo() {
            ...
            $('.sys-part-title').each(function () {
                if ($.trim($(this).children(":first").text()) == "Case") {
                    $('#sysCaseLogo').attr('src', 'https://lucomputers.com/pro_img/COMPONENTS/' + $(this).attr('partsku') + '_g_1.jpg');
                }
            });
        }
        ...
        function showPartDetailList(the) {
            ...
            if (detailArea.css('display') == 'none') {
                ...
                if ($.trim(detailArea.html()) == "") {
                    detailArea.html("<img src='images/loaderc.gif'>");
                ...
                success: function (m, s) {
                    if (s == "success") {
                        ...
                        if (t == "saveQuote") {
                            ...
                            window.location.href = 'ShoppingCartTo.aspx?sku=' + m;
                        }
                        else
        ...
        function saveQuote() {
            $('#showQuote').find(".modal-body").eq(0).html("<img src=\"images/loaderc.gif\" />");
