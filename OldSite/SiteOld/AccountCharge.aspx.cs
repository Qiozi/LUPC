            ...
            if (CountryID == CountryCategoryHelper.CountryCategory_value(CountryCategory.CA))
            {
                if (PstRate > 0)
                {
                    if (lbl_sales_tax.Text.Length > 2)
                    {
                        ...
                        lbl_sales_tax.Text += "&nbsp; &nbsp; &nbsp;<br/>" + mm.pst.ToString("$###,###.00");
                    }
                    else
                    {
                        lbl_sales_tax.Text = mm.pst.ToString("$###,###.00");
                ...
                if (GstRate > 0)
                {
                    if (lbl_sales_tax.Text.Length > 2)
                    {
                        lbl_sales_tax.Text += "&nbsp; &nbsp; &nbsp;<br/>" + mm.gst.ToString("$###,###.00");
                        lbl_state_tax.Text += "<br/>GST(" + GstRate.ToString() + "%)：";
                    }
                    else
                    {
                        lbl_sales_tax.Text = mm.gst.ToString("$###,###.00");
                ...
                if (HstRate > 0)
                {
                    if (lbl_sales_tax.Text.Length > 2)
                    {
                        lbl_sales_tax.Text += "&nbsp; &nbsp; &nbsp;<br/>" + mm.hst.ToString("$###,###.00");
                        lbl_state_tax.Text += "<br/>HST(" + HstRate.ToString() + "%)：";
                    }
                    else
                    {
                        lbl_sales_tax.Text = mm.hst.ToString("$###,###.00");
