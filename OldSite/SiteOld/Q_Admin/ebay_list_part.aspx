<%@ Page Language="C#" MasterPageFile="~/Q_Admin/ebay.master" AutoEventWireup="true" CodeFile="ebay_list_part.aspx.cs" Inherits="Q_Admin_ebay_list_part" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="btn_list">
        <a href="" onclick="ParentLoadWait();parent.window.ViewPartDetail(-1);" class="a_btn">New</a>
            ...
            <legend>Search</legend>
                 <asp:Panel ID="Panel1" runat="server" Height="30px" >
                    ...
                    <asp:Button ID="btn_search" runat="server" onclick="btn_search_Click" 
                        ...
                        <asp:Button ID="btn_clear_search" runat="server" 
                        Text="Clear Search"  OnClientClick="ParentLoadWait();" 
                         onclick="btn_clear_search_Click" style="height: 26px"/>
                        keyword: sku, ebay sku, ebay NO#</asp:Panel>
        </fieldset>       
            ...
            <ItemTemplate> 
                <tr>
                    <td style="text-align:center; width: 150px">
                        <img src="http://www.lucomputers.com/pro_img/COMPONENTS/<%# DataBinder.Eval(Container.DataItem, "img_sku") %>_t.jpg" />
                        <br />[<asp:Label runat="server" ID="_lbl_id" Text='<%# DataBinder.Eval(Container.DataItem, "id") %>'></asp:Label>]
                    </td>
                    <td valign="top">
                        <div>
                            [<%# DataBinder.Eval(Container.DataItem, "lu_ebay_sku")%>] &nbsp;&nbsp;<%# DataBinder.Eval(Container.DataItem, "ebay_store_comment")%>
                        </div>
                    ...
                    <td style="width: 70px">
                        <a href="" onclick="parent.window.ViewPartDetail(<%# DataBinder.Eval(Container.DataItem, "id") %>);">modify</a>
                        <div>
                            <a href="/view_for_ebay.asp?cate=1&id=<%# DataBinder.Eval(Container.DataItem, "id") %>" onclick="js_callpage_name_custom(this.href, 'view_flash', 900, 800); return false;">View</a><br />
                            ebay view
                            <a href="/view_in_flash.asp?cate=1&id=<%# DataBinder.Eval(Container.DataItem, "id") %>" onclick="js_callpage_name_custom(this.href, 'view_flash', 760, 410); return false;">Flash View</a>
                        </div>
                    </td>
                </tr>
                <tr>
