<%@ Page Language="C#" MasterPageFile="~/Q_Admin/None.master" AutoEventWireup="true" CodeFile="ebay_manager_iframe.aspx.cs" Inherits="Q_Admin_ebayMaster_LU_ebay_manager_iframe" Title="Ebay Manager" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
        <tr>
                ...
                <!-- the 'panes' -->
                <div class="panes">
                    <div><iframe id="Iframe1" name="ifr_left_frame2" src="/q_admin/ebayMaster/lu/ebay_left_menu.asp?pageType=1" frameborder="0" style="width: 100%"></iframe></div>
