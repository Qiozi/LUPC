<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ebay_system_temp_page_view.aspx.cs" Inherits="Q_Admin_ebayMaster_ebay_system_temp_page_view" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div id='ebay_page_cont_area' style="margin-top: 100px;">
    ...
    <script type="text/javascript">
        ...
        function Down() {
            $('#content').val($('#ebay_page_cont_area').html());
        }
    </script>
</body>
</html>
