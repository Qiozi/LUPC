                        ...
                        <li>
                            <table cellpadding="0" cellspacing="0" style="border: 0px solid #ccc; width: 150px;">
                                <tr>
                                    ...
                                    <td>
                                        <img src="/images/arrow_5.gif" alt="Press" title="Press" style="height: 19px; width: 15px; cursor: pointer" onclick="document.getElementById('uc_dropDownList_category_selected').style.display = '';" /></td>
                                </tr>
                            </table>
                        </li>
                    </ul>
