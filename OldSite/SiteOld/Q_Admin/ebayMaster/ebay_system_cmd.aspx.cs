...
public partial class Q_Admin_ebayMaster_ebay_system_cmd : PageBase
{
    ...
    public void SysReplacePart()
    {
        ...
        if (count > 0)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                ProductModel pm = ProductModel.GetProductModel(ReqNewPartSku);
                if (pm != null)
                {
...
"
    ...
    void GetEbaySystemPrices(int system_sku)
    {
            ...
            if (ReqIs_shrink)
            {
                ...
                decimal adjustment = GetEbayPrice.GetEbaySysAdjustment(system_sku, ref ESM);
                ...
                decimal flash_price = GetEbayPrice.GetSysPrice(system_sku
