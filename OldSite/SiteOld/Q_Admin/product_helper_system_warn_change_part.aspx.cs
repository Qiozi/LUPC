...
public partial class Q_Admin_product_helper_system_warn_change_part : PageBase
{
    ...
    {
        PartGroupDetailModel pgdm = new PartGroupDetailModel();// PartGroupDetailModel.GetPartGroupDetailModelsByPartGroupID(GroupID);
        this.RadioButtonList1.DataSource = pgdm.FindPartIDAndNameByGroupID(GroupID);
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        try
        {
            EbaySystemPartsModel spm = EbaySystemPartsModel.FindAllByProperty("id",SystemProductID)[0];
