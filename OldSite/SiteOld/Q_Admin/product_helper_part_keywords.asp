...
<body>
    ...
    <table width="100%">
        <tr>
            <td width="250">	
            	<img src="<%= HTTP_PART_GALLERY & img_sku%>_list_1.jpg" width="250" />
            </td>
            <td  valign="top">
                <a href="http://www.lucomputers.com/site/product_parts_detail.asp?id=<%= id %>&cid=<%= cid %>" target="_blank"><h3><%= id %></h3></a>
                <p> <a href="http://www.lucomputers.com/site/product_parts_detail.asp?id=<%= id %>&cid=<%= cid %>" target="_blank" id="part_name"><%= product_long_name %></a></p>
