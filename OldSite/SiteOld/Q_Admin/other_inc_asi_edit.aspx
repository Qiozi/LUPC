<%@ Page Title="" Language="C#" MasterPageFile="~/Q_Admin/None.master" AutoEventWireup="true" CodeFile="other_inc_asi_edit.aspx.cs" Inherits="Q_Admin_other_inc_asi_edit" %>
...
<table>
                ...
                <tr>
                        <td>MFP #:</td>
                        <td><asp:TextBox runat="server" ID="txt_mfp_code" TabIndex="7"></asp:TextBox>c</td>
                </tr>
                <tr>
                        <td>Priority</td>
                ...
                <tr>
                        <td>ASI SKU*</td>
                        <td><asp:TextBox runat="server" ID="txt_supercom_sku" TabIndex="8"></asp:TextBox></td>
                </tr>
        </table>
</asp:Content>
