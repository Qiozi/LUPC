...
public partial class Q_Admin_orders_edit_detail_shipping_address :PageBase
{
    ...
    protected void btn_save_shipping_address_Click(object sender, EventArgs e)
    {
        ...
        if (ddl_shipping_country.SelectedValue.ToLower() == "other")
        {
            ...
            int stateID = new StateShippingModel().SaveNewState(cm.shipping_country_code, cm.shipping_state_code).state_serial_no;
        ...
        else
        {
            ...
            cm.customer_shipping_state = StateShippingModel.FindStatIDByCode(cm.shipping_state_code);
        }
        ...
        else
        {
            ...
            csm.customer_shipping_state = StateShippingModel.FindStatIDByCode(cm.shipping_state_code);
        }
        ...
        InsertTraceInfo(string.Format("Save Order Price({0}) shipping address.", ReqOrderCode));
