...
public partial class Q_Admin_orders_edit_detail_personal_information : PageBase
{
    ...
    protected void btn_save_personal_info_Click(object sender, EventArgs e)
    {
        ...
        {           
            ...
            new StateShippingModel().SaveNewState(cm.customer_country_code, cm.state_code);
        }
        else
        {
        ...
        InsertTraceInfo(string.Format("Save Order Price({0}) personial info...", ReqOrderCode));
        if (ReqIsNew)
        {
