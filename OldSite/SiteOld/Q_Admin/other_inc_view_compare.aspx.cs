...
//        return "";
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        ...
        if (special_cash != 0M)
        {
            ProductModel pm = ProductModel.GetProductModel(LUSKU);
            pm.product_current_price = ConvertPrice.SpecialCashPriceConvertToCardPrice(pm.product_current_discount + special_cash);
