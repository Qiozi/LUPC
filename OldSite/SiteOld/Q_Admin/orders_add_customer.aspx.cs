    ...
    private void CustomerCmd(Command cmd)
    {
        try
        {
            ...
            {               
                ...
                new StateShippingModel().SaveNewState(model.customer_country_code, model.state_code);
            }
            else
            {
            ...
            if (ddl_customer_card_country.SelectedValue.ToLower() == "other")
            {
                ...
                new StateShippingModel().SaveNewState(model.customer_card_country_code, model.customer_card_state_code);
            }
            else
            {
            ...
            if (ddl_customer_shipping_country.SelectedValue.ToLower() == "other")
            {
                ...
                new StateShippingModel().SaveNewState(model.shipping_country_code, model.shipping_state_code);
            }
            else
            {
            ...
            if (ddl_business_country.SelectedValue.ToLower() == "other")
            {
                ...
                new StateShippingModel().SaveNewState(model.customer_business_country_code, model.customer_business_state_code);
            }
            else
            {
