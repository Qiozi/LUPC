...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lb_content" runat="server"></asp:Label><div style="display: none">
            ...
            <p class="EC_MsoNormal">
                <font color="navy" face="Courier New" size="2"><span style="font-size: 10pt; color: navy; font-family: 'Courier New'">1875 Leslie St.</span></font><font color="navy" face="Courier New"
                    size="2"><span style="font-size: 10pt; color: navy; font-family: 'Courier New'"> Unit 24 </span></font>
            </p>
            <p class="EC_MsoNormal">
                <font color="navy" face="Courier New" size="2"><span style="font-size: 10pt; color: navy; font-family: 'Courier New'">Toronto</span></font><font color="navy" face="Courier New"
