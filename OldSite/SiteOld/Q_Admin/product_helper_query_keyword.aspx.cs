...
select * from tb_product_category_keyword where category_id='{0}' order by priority, id asc", category_id));
    ...
    protected void btn_new_query_cate_Click(object sender, EventArgs e)
    {
        ...
        {
            ProductCategoryKeywordModel pckm = new ProductCategoryKeywordModel();
    ...
    protected void lv_keyword_cate_list_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        switch (e.CommandName)
        {
            case "SaveParentKeyword":
                ...
                ProductCategoryKeywordModel pckm = ProductCategoryKeywordModel.GetProductCategoryKeywordModel(int.Parse(e.CommandArgument.ToString()));
            ...
            case "NewChildCateKeyword":
                ...
                if (keyword.Length > 0)
                {                   
                    ProductCategoryKeywordSubModel pcksm = new ProductCategoryKeywordSubModel();
    ...
    protected void btn_save_cates_id_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ProductCategoryModel pcm = ProductCategoryModel.GetProductCategoryModel(CurrentCategoryID);
