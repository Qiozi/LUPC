...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        input {font-size:8.5pt; color:#5D5DBE}
        .style1
        {
            width: 105px;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <hr size="1" style="clear:both;"/>
        ...
        onselectedindexchanged="ddl_category_1_SelectedIndexChanged"></asp:DropDownList>
        <asp:DropDownList runat="server" ID="ddl_category_2" AutoPostBack="true" 
        onselectedindexchanged="ddl_category_2_SelectedIndexChanged"></asp:DropDownList>
        <asp:DropDownList runat="server" ID="ddl_category_3" AutoPostBack="true" 
        onselectedindexchanged="ddl_category_3_SelectedIndexChanged"></asp:DropDownList>
    ...
    <asp:Panel runat="server" ID="panel_part_info">
        <table >
            <tr>
                <td align="center" colspan="4" style="border-bottom: 1px solid #C7C7F1; font-size:10pt; font-weight:bold;">
            ...
            <tr>
                <td>
                    Special Cash</td><td style="width: 250px;">       
        ...
        <tr>
            <td>
                ...
                <asp:TextBox runat="server" ID="txt_desc" Columns="100" Rows="10" 
                    ...
                    <br /><b>Short Comment(Max length < 1800 )</b>
                    <br />
