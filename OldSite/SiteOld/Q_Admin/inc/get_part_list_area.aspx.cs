...
on e.luc_sku=t.luc_sku and NewBuyItNowPrice<>e.BuyItNowPrice) t group by luc_sku) ebi on ebi.luc_sku=p.product_serial_no";
        ...
        else
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                sb.Append("                 <span title='eBayOnline' " + (ebay_style) + ">" + dr["is_ebay_online"].ToString() + "</span>");
                ...
                sb.Append("          <a href=\"/q_admin/editPartDetail.aspx?id=" + sku.ToString() + "\" onclick=\"js_callpage_cus(this.href, 'modify_detail', 880, 800);return false;\" title=\"Modify Detail\">Edit</a>|<a href=\"/q_admin/editPartDetail.aspx?cmd=1&id=" + sku.ToString() + "\" onclick=\"js_callpage_cus(this.href, 'modify_detail', 880, 800);return false;\" title=\"Modify Detail Comment\">Edit Comm</a><br /> ");
                sb.Append("          <a href=\"/q_admin/ebayMaster/ebay_part_comment_edit.asp?sku=" + sku.ToString() + "\" onclick=\"js_callpage_cus(this.href, 'ebay_part_comment_edit', 780, 500);return false;\" title='Edit Ebay'>Edit</a>|<a href=\"/q_admin/ebayMaster/ebay_part_temp_page_view.aspx?sku=" + sku.ToString() + "\" target=\"_blank\" title=\"view ebay\">view ebay</a>");
                ...
                sb.Append("     <div>eBay Itemid: <a href=\"http://cgi.ebay.ca/ws/eBayISAPI.dll?ViewItem&amp;Item=" + dr["ItemID"].ToString() + "\" target=\"_blank\">" + dr["ItemID"].ToString() + "</a></div>");
