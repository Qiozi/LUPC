...
'-------------------------------------------------------------------------------------------	
	...
	If ack=UCase("Success") Then
		...
		'
	    response.Redirect("shopping_cheout_order_ok.asp?TRANSACTIONID="&resArray("TRANSACTIONID"))
		response.End()
	Else       
...
<html>
    ...
    %>
			<br>
			<a class="home" href="http://www.lucomputers.com/"><font color="blue"><B>Home<B><font></a>
		</body>
	</html>
