                ...
                cellpadding="0">
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><strong>&nbsp;&nbsp;&nbsp;PAYING BY BANK TRANSFER</strong></td>
                                ...
                                <table width="80%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td class="text_hui_11">
                                        Please&nbsp;submit&nbsp;your&nbsp;order&nbsp;and&nbsp;then&nbsp;wire&nbsp;transfer&nbsp;payment.&nbsp;We&nbsp;will&nbsp;email&nbsp;you&nbsp;
                                                                                the&nbsp;account&nbsp;information&nbsp;that&nbsp;you&nbsp;can&nbsp;send&nbsp;to.</td>
                                  </tr>
                                ...
                                <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">                                  
                                  <tr>
                                    <td class="text_hui_11">
                                      <p>To avoid currency discrepancy, payment must be made in <strong>Canadian Dollars</strong>. Please notify us after you have made your payment; please send us a copy of your payment receipt.</p>
                                      <p>Bank wire is only necessary if you do not have a TD Canada Trust account. If you have a TD account you can simply make a <strong>direct transfer</strong> by calling the bank, or transfer using online banking. </p>
                                      <p>Wire transfer is not an instant payment. Your funds usually takes 1-3 days to reach our account. Wire transferring from some foreign countries can take longer. </p>
                                      <p><strong>NOTE:</strong> All items on below form are required.<br>                      
                                      </p>                      </td>
                                  </tr>
                                </table>
                                ...
                                %>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td valign="top"><span class="text_hui_11">
                                        <input name="shipping_city" id="shipping_city" type="text" class="input9pt" style="width:150px; " size="13"  value="<%= v_customer_shipping_city %>" tabindex="5">
                                      </span></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <tr align="right">
                                        <td><table id="__01" width="130" height="24" border="0" cellpadding="0" cellspacing="0" class="btn_table" onclick="gotoBackCart('<%= LAYOUT_CURRENT_ORDER_TYPE %>');">
                                            <tr>
                                              ...
                                              <td align="center" class="btn_middle"><strong><a class="btn_img"  onclick="gotoBackCart('<%= LAYOUT_CURRENT_ORDER_TYPE %>');" tabindex="13">Back</a> </strong></td>
                                              <td width="6"><img src="/soft_img/app/customer_bottom_04.gif" width="6" height="24" alt=""></td>
                                            </tr>
                                        </table></td>
                                        <td><table id="__01" width="130" height="24" border="0" cellpadding="0" cellspacing="0" onClick="Check(document.getElementById('form2'));" class="btn_table">
                                            <tr>
                                              <td width="28"><img src="/soft_img/app/arrow_right.gif" width="28" height="24" alt=""></td>
                                              <td align="center"class="btn_middle"><a class="btn_img" onClick="Check(document.getElementById('form2'));" tabindex="14"><strong>Next</strong></a></td>
                                              <td width="6"><img src="/soft_img/app/customer_bottom_04.gif" width="6" height="24" alt=""></td>
                                            </tr>
                                        </table></td>
                                      </tr>
