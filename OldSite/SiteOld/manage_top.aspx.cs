...
public partial class mamage_top : PageBase
{
    ...
    {
        this.DataGrid1.DataSource = TopModel.FindAll();
  ...
  <tr>
    <td style=""border:#E3E3E3 1px solid; ""><table width=""100%""  border=""0"" align=""center"" cellpadding=""2"" cellspacing=""0"">";
        ...
        for (int i = 0; i < this.DataGrid1.Items.Count; i++)
        {
            ...
            TopModel tm = TopModel.GetTopModel(id);
            tm.top_sku = sku;
            ...
            {
                ProductModel p = ProductModel.GetProductModel(sku);
            ...
            ProductCategoryModel pc = ProductCategoryModel.GetProductCategoryModel(cid);
