...
public class MenuHelper
{
    ...
    public string LoadMenu()
    {
            ...
            MenuModel[] parent = MenuModel.MenuModelsByMenuParentSerialNo(0,true);
            for (int i = 0; i < parent.Length; i++)
            {
                ...
                {
                    MenuModel[] mm = MenuModel.MenuModelsByMenuParentSerialNo(parent[i].menu_child_serial_no, true);
