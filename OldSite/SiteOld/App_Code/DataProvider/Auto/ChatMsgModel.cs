...
[ActiveRecord("tb_chat_msg")]
[Serializable]
public class ChatMsgModel : ActiveRecordBase<ChatMsgModel>
{
    int _msg_id;
    ...
    public static ChatMsgModel[] FindModelsByOrderCode(string order_code)
    {
        return ChatMsgModel.FindAllByProperty("msg_order_code", order_code);
    }
