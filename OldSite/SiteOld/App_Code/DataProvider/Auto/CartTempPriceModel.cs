...
[ActiveRecord("tb_cart_temp_price")]
public class CartTempPriceModel : ActiveRecordBase<CartTempPriceModel>
{
    ...
    public static CartTempPriceModel GetModelsByOrderCode(string order_code)
    {
