...
public class Account
{
	...
	public Account(AccountProduct[] ap, int state_shipping)
	{
		//
		// TODO: 在此处添加构造函数逻辑
		//
    ...
    public decimal getResult()
    {
        ...
        if ((Config.army_shipping_company == _shiping_company &&
            Config.army_state.IndexOf( _state_shipping .ToString("[0]")) == -1) || (Config.army_shipping_company != _shiping_company &&
            Config.army_state.IndexOf(_state_shipping.ToString("[0]")) != -1))
        {
