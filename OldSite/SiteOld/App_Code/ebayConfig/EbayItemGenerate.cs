...
public class EbayItemGenerate : PageBase
{
    ...
    public string AddItem(EbayItem ei, string shippingDetail, int SKU, int Vcsid
        , bool IsSystem
        , bool IsChild)
    {
        #region settings
...
<AddItemRequest xmlns=""urn:ebay:apis:eBLBaseComponents"">
  ...
  <Item>
    ...
    public static string GetItem(string itemId, string outputSelector, int SKU, bool IsSys)
    {
        #region settings
