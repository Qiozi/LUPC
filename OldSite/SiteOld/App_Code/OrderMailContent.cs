...
public class OrderMailContent
{
    ...
    {
        return SendContent(order_code, string.Empty);
    }
    
    public string SendContent(string order_code, string noteString)
    {
        OrderHelperModel[] ohm = OrderHelperModel.GetModelsByOrderCode(int.Parse(order_code));
        if (ohm.Length != 1)
            throw new Exception("Order Code is error!");
        CustomerStoreModel[] csm = CustomerStoreModel.FindModelsByOrderCode(order_code);
        if (csm.Length != 1)
            ...
            || ohm[0].input_order_discount > 0)
        {
            ...
            special_cash_discount = @"<div class=""EC_MsoNormal"">
                        <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                            ...
                            font-family: 'Courier New'"">-" + Config.ConvertPrice(ohm[0].input_order_discount > 0 ? ohm[0].input_order_discount : ohm[0].sur_charge) + @"</span></td><td style=""font-size: 10pt; color: navy;
        ...
        pay_method_name = @"<div class=""EC_MsoNormal"">
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">&nbsp;&nbsp;&nbsp;Pay Method:&nbsp;" + PayMethodNewModel.GetPayMethodNewModel(pay_method_id).pay_method_name + @"</span></font>
        </div>";
        ...
        if (ohm[0].gst_rate > 0M)
        {
            ...
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                ...
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].gst) + @"</span></td><td><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">GST(" + ohm[0].gst_rate.ToString("###") + @"%)</span></td></tr></table></span></font></div>";
        }
        ...
        if (ohm[0].pst_rate > 0M)
        {
            ...
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""></span></font><font color=""navy"" face=""Courier New""
                    size=""2""><span style=""font-size: 10pt; color: navy; font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].pst) + @"</span></td><td><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">PST(" + ohm[0].pst_rate.ToString("###") + @"%)</span></td></tr></table></span></font></div>";
        }
        ...
        if (ohm[0].hst_rate > 0M)
        {
            ...
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""></span></font><font color=""navy"" face=""Courier New""
                    size=""2""><span style=""font-size: 10pt; color: navy; font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].hst) + @"</span></td><td><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">HST(" + ohm[0].hst_rate.ToString("###") + @"%)</span></td></tr></table></span></font></div>";
        }
        ...
        if (ohm[0].weee_charge > 0M)
        {
            ...
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""></span></font><font color=""navy"" face=""Courier New""
                    size=""2""><span style=""font-size: 10pt; color: navy; font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].weee_charge) + @"</span></td><td><span style=""font-size: 10pt; color: navy;
...
" + ((csm[0].customer_company ?? "") == "" ? "" : @"<div class=""EC_MsoNormal"">
        ...
        <div class=""EC_MsoNormal"">
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].sub_total_rate) + @"</span></td><td style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">Sub-Total</td></tr></table></span></font></div>
        " + special_cash_discount + @"        
        <div class=""EC_MsoNormal"">
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].shipping_charge) + @"</span></td><td style=""font-size: 10pt; color: navy;
        ...
        <div class=""EC_MsoNormal"">
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'""><table><tr><td width='40'>&nbsp;</td><td width='150'><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(ohm[0].grand_total) + @"</span></td><td style=""font-size: 10pt; color: navy;
        ...
        for (int i = 0; i < opm.Length; i++)
        {
            ...
            sb.Append(@"<div class=""EC_MsoNormal"">
            <font color=""navy"" face=""Courier New"" size=""2""><span style=""font-size: 10pt; color: navy;
                font-family: 'Courier New'"">" + Config.ConvertPrice(opm[i].order_product_sold) + @" x " + opm[i].order_product_sum.ToString() + "&nbsp;&nbsp;" + (order_code.Length ==5? ((opm[i].ebayItemID == null || opm[i].ebayItemID.Length <7) ? opm[i].product_serial_no.ToString() : opm[i].ebayItemID ): opm[i].product_serial_no.ToString()) + @"&nbsp;&nbsp;" + opm[i].product_name + @"&nbsp;&nbsp;</span></font>
        </div>");
