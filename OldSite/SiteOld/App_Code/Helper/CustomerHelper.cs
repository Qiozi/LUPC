...
public class CustomerHelper
{
    ...
    {
        CustomerModel cm = CustomerModel.GetCustomerModel(customer_id);
       
        CustomerStoreModel csm = new CustomerStoreModel();
        ...
        csm.news_latter_subscribe = cm.news_latter_subscribe;
        int oc;
