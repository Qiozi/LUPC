...
public class PDFHelper
{
    ...
    public void CreatePDF(int orderCode, ref string pdf_path_file, ref string error, System.Web.UI.Page Page)
    {
            ...
            || orderCode.ToString().Length == 5)
        {
            ...
            OrderHelperModel[] ohms = OrderHelperModel.GetModelsByOrderCode(orderCode);
            ...
            try
            {
                ...
                Cell c15 = new Cell(new Phrase(new Chunk(ohms[0].order_date.ToShortDateString(), font11).SetTextRise(4)));  // order_date
                ...
                tAddress.AddCell(new Phrase(" ", font11B));
                tAddress.AddCell(new Phrase((csm[0].customer_address1 ?? "").Trim().Length < 5 ? "" : (csm[0].customer_city + " " + StateShippingModel.GetStateShippingModel(csm[0].customer_card_state).state_short_name + " " + csm[0].zip_code), font11));     // sale: city, state, zipcode
                ...
                //if (ohms[0].tax_charge != 0)
                {
                    ...
                    {
                        Cell c77_1 = new Cell(new Phrase("GST(" + ohms[0].gst_rate.ToString("##") + "%)", font11));
                        c77_1.BorderWidth = 0f;
                        tPrice.AddCell(c77_1);

                        Cell c78_1 = new Cell(new Phrase(Config.ConvertPrice2(ohms[0].gst), font11));
                    ...
                    {
                        Cell c77_2 = new Cell(new Phrase("PST(" + ohms[0].pst_rate.ToString("##") + "%)", font11));
                        c77_2.BorderWidth = 0f;
                        tPrice.AddCell(c77_2);

                        Cell c78_2 = new Cell(new Phrase(Config.ConvertPrice2(ohms[0].pst), font11));
                    ...
                    {
                        Cell c77_3 = new Cell(new Phrase("HST(" + ohms[0].hst_rate.ToString("##") + "%)", font11));
                        c77_3.BorderWidth = 0f;
                        tPrice.AddCell(c77_3);

                        Cell c78_3 = new Cell(new Phrase(Config.ConvertPrice2(ohms[0].hst), font11));
                    ...
                    if (ohms[0].weee_charge > 0M)
                    {
                        ...
                        Cell c78_4 = new Cell(new Phrase(Config.ConvertPrice2(ohms[0].weee_charge), font11));
