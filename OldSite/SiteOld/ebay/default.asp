...
<%
	...
	CAll CurrentSystemDefault("ebay", CurrentIsEbay)
	response.redirect "/ebay/list.asp?id=&sortby=2&category_query_keys=,-1|0,-1|6,-1|7,-1|8,-1|9"
	response.End()
	...
	<tr>
        ...
        <td id="page_main_center" valign="top" style="width:600px" class='page_frame'>
        	<!-- main begin -->
        	    ...
        	    <div class="page_main_nav" id="page_main_nav">Ebay</div>
