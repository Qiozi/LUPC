...
public class AskQuestionModel 
{
    ...
    //}
    public static tb_ask_question GetAskQuestionModel(LU.Data.nicklu2Entities context, int _aq_serial_no)
    {
        ...
        var query = context.tb_ask_question.Single(me => me.aq_serial_no.Equals(_aq_serial_no));
        return query;
    }
