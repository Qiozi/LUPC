...
public class HttpHelper
{
    ...
    /// <param name="url"></param>
    /// <returns></returns>
    public string GetPageString(nicklu2Entities context, string page_name, string url)
    {
        string p = this.HttpGet(url);
        var models = TempleteReplaceParameterModel.FindModelsByPageName(context, page_name);
