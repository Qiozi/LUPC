                	...
                	<table width="600" height="750" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF" style="border:#8FC2E2 1px solid; ">
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                <select style="width: 200px;" name="categories">
                                                    ...
                                                    <% 
                                                       set rs = conn.execute("select menu_child_serial_no, menu_child_name, page_category from tb_product_category where menu_pre_serial_no=0 and tag=1 order by menu_child_order asc ")
                                                       if not rs.eof then
                                                            
                                                                do while not rs.eof 
                                                                    if rs("page_category") = 0 then
                                                                        Response.Write "<optgroup Label='"& rs("menu_child_name") &"'>"&vblf
                                                                        Response.Write "<option value=""1000"""
                                                                        if categories = "1000" then response.Write " Selected='selected' "
                                                                        Response.Write ">"& rs("menu_child_name") &"</option>"
                            ...
                            <tr>
                              ...
                              <%
                                ...
                                ''
                                ' part
                                if categories <> "-1" and categories<>"" and  is_virtual = 0 and categories <>"1000" then
                                ...
                                if categories= "1000" then
                                    ...
                                    sysSql1 = " select distinct 0, 2 as product_category,'0' as product_type, '0' as split_line, st.ebay_system_name product_short_name,st.ebay_system_name product_name_long_en,st.id product_serial_no,0 as system_templete_price, st.ebay_system_name product_name, "&_
                                            ...
                                            " where ((ep.ebay_code='"& keyword &"'or st.id='"& keyword &"')  or st.id in (" & SysSkus &")) "& sys_params_sql  
            	...
            	'response.write search_sql_1
                                ...
                                if  (keyword <> "" ) then
										...
										'	response.write int(rsc(0)/ps)
											search_split_page = " order by product_serial_no desc limit "& ps*(page-1) &","&ps
                              ...
                              %>
                                  ...
                                  <% 
                                    ...
                                    ' ------system product begin -----------------
											...
											response.Write("<td style='min-height: 40px;'><a  href=""/site/system_view.asp?cid="& rs("product_type") &"&id="& rs("product_serial_no")&"&class="&request("class")&""" target='_blank'><span id='logo_cpu_name'  class=""system_title100"" >")
...
%>
                                                  ...
                                                  <td></td>
                                                  <td><a href="/site/system_view.asp?cid=<%= rs("product_type") %>&class=1&id=<%=rs("product_serial_no")%>" target="_blank"><img src="/soft_img/app/select_bt.gif" width="56" height="13" border="0"></a></td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                      </table></td>
