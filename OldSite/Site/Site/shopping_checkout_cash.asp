        	...
        	<!-- main begin -->
                ...
                cellpadding="0">
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><strong>&nbsp;&nbsp;&nbsp;PAYING BY CASH DEPOSIT</strong></td>
                                ...
                                <table width="80%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td class="text_hui_11">If you are in Canada, you can make cash deposit to the nearest TD Canada Trust branch. We will send you our account number right after you plalce your order. 
</td>
                                  </tr>
                                  </table>
                                <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td class="text_hui_11"><!--<span class="text_hui_11">Please request the teller to make your name or order number on your payment. To speed up verifying payment please specify <strong>CASH</strong> on your payment. Please contact us right after you have made your deposit.
                                      </span> -->   
                                      Please ask the teller to add your name on your transaction to show on LU Computers' banking screen.  Otherwise we will be difficult to identify your payment. Please contact us right after you have made your deposit.
                                      <p class="text_hui_11"><strong>NOTE:</strong> Most items on this form are required.</p> 
                                                       <!-- <p class="text_hui_11"><strong>NOTE:</strong> Most items on this form are required.<br>                      
                                      </p>         -->             </td>
                                  </tr>
                                </table>
                ...
                '							end if
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td valign="top"><span class="text_hui_11" id="div_state">
                                       <input name="shipping_state" id="shipping_state" type="hidden" value="<%=LAYOUT_SHIPPING_STATE_CODE %>"><%= LAYOUT_SHIPPING_STATE_CODE%>&nbsp;&nbsp;<a href="<%= LAYOUT_HOST_URL %>Shopping_Cart.asp" style="color: blue;">Change</a>
                                ...
                                <table width="100%"  border="0" cellpadding="3" cellspacing="0">
                                  <tr>
                                    <td align="center"><table width="45%"  border="0" cellpadding="3" cellspacing="0">
                                      <tr align="right">
