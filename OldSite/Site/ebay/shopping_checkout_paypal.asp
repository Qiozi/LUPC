                                      ...
                                      <tr align="right">
                                        <td><table id="__01" width="130" height="24" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              ...
                                              <td align="center" background="/soft_img/app/customer_bottom_03.gif"  class="btn_style"><strong><a style="cursor: pointer;color: #FFFFFF;"  onclick="window.location.href='shopping_check_out.asp?Pay_method=16';" tabindex="13">Back</a> </strong></td>
