...
'connString	= 	"Driver={MySQL ODBC 3.51 Driver};SERVER=localhost;DATABASE=nicklu2;UID=root;PWD=1234qwer;OPTION="& 1 + 2 + 8 + 32 + 2048 + 16384
'connString	= 	"Driver={MySQL ODBC 3.51 Driver};SERVER=localhost;DATABASE=nicklu2;UID=root;PWD=1234qwer;OPTION="& 1 + 2 + 8 + 32 + 2048 + 16384
...
if not tmpReadDeny and tmpReadIp <>"127.0.0.1" then 
