...
public partial class Q_Admin_product_helper_product_category : PageBase
{
    ...
    {
        this.dg1.DataSource = ProductCategoryModel.ProductCategoryModelsParentAll(DBContext);
        this.dg1.DataBind();
    }
    ...
    {
        this.dg2.DataSource = ProductCategoryModel.ProductCategoryModelsByMenuPreSerialNo(DBContext, id);
        this.dg2.DataBind();
    }

    private void BindDG3(int id, bool autoUpdate)
    {
        this.dg3.DataSource = ProductCategoryModel.ProductCategoryModelsByMenuPreSerialNo(DBContext, id);
        this.dg3.DataBind();
    }
    #endregion
    ...
    protected void btnSave1_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < this.dg1.Items.Count; i++)
        {
            ...
            var model = ProductCategoryModel.GetProductCategoryModel(DBContext, serial_no);
            model.menu_child_name = ((TextBox)this.dg1.Items[i].Cells[1].FindControl("_txtName")).Text;
            model.page_category = (sbyte)(((CheckBox)this.dg1.Items[i].Cells[3].FindControl("_cbPageCategory")).Checked == true ? 1 : 0);
            model.tag = sbyte.Parse(((CheckBox)this.dg1.Items[i].Cells[4].FindControl("_cbShowit")).Checked == true ? "1" : "0");
            model.menu_child_order = int.Parse(((TextBox)this.dg1.Items[i].Cells[5].FindControl("_txtOrder")).Text.Trim());
            model.is_noebook = sbyte.Parse(((CheckBox)this.dg1.Items[i].Cells[6].FindControl("_cb_noebook")).Checked == true ? "1" : "0");
    ...
    protected void btnSave2_Click(object sender, EventArgs e)
    {
        try
        {
            for (int i = 0; i < this.dg2.Items.Count; i++)
            {
                ...
                model.page_category = (sbyte)(((CheckBox)this.dg2.Items[i].Cells[3].FindControl("_cbPageCategory2")).Checked == true ? 1 : 0);
                model.tag = sbyte.Parse(((CheckBox)this.dg2.Items[i].Cells[4].FindControl("_cbShowit2")).Checked == true ? "1" : "0");
                model.menu_child_order = int.Parse(((TextBox)this.dg2.Items[i].Cells[5].FindControl("_txtOrder2")).Text.Trim());
                model.is_noebook = sbyte.Parse(((CheckBox)this.dg2.Items[i].Cells[6].FindControl("_cb_noebook_child")).Checked == true ? "1" : "0");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < this.dg3.Items.Count; i++)
        {
            ...
            model.page_category = (sbyte)(((CheckBox)this.dg3.Items[i].Cells[2].FindControl("_cbPageCategory3")).Checked == true ? 1 : 0);
            model.tag = sbyte.Parse(((CheckBox)this.dg3.Items[i].Cells[3].FindControl("_cbShowit3")).Checked == true ? "1" : "0");
            model.menu_child_order = int.Parse(((TextBox)this.dg3.Items[i].Cells[4].FindControl("_txtOrder3")).Text.Trim());
            model.is_noebook = sbyte.Parse(((CheckBox)this.dg3.Items[i].Cells[5].FindControl("_cb_noebook_sub")).Checked == true ? "1" : "0");
    ...
    {
        var model = new tb_product_category();// ProductCategoryModel();
        ...
        DBContext.tb_product_category.Add(model);
        DBContext.SaveChanges();

        if (parentID != 1)
        {
            model = ProductCategoryModel.GetProductCategoryModel(DBContext, parentID);
