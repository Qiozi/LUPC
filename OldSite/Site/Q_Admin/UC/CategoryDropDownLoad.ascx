                ...
                <asp:TextBox ID="txt_text" runat="server" Columns="25" 
                 ...
                 <div style="left:auto; top: 16px; display:none" id="uc_dropDownList_category_selected">
                        <asp:Literal ID="Literal1" runat="server"></asp:Literal>
                            ...
                            <td><img src="/q_admin/images/arrow_5.gif" alt="Press" title="Press" style="height: 19px;width: 15px; cursor:pointer" onclick="document.getElementById('uc_dropDownList_category_selected').style.display = '';" /></td>
                    </tr>
            </table>
