...
public partial class Q_Admin_OpenFlashChartData : PageBase
{
    ...
    void GetStat360Days()
    {
        ...
        {
            data = new ChartJsItem
            {
                datasets = new List<ChartSubItem>(),
                labels = new List<string>()
            }
        };
        var labels = new List<string>();
        var lastYearValueWeb = new List<double>();
        var thisYearValueWeb = new List<double>();
        var lastYearValueEbay = new List<double>();
        var thisYearValueEbay = new List<double>();

        for (int i = 0; i < dayYear.Rows.Count; i++)
        {
            DataRow dr = dayYear.Rows[i];
            labels.Add(dr["pre_M"].ToString().Split(new char[] { ' ' })[0]);

            double grandTotal;
            double.TryParse(dr["grand_total"].ToString(), out grandTotal);
            webValue.Add(grandTotal);
            webTotal += grandTotal;
            thisYearValueWeb.Add(grandTotal);
            ...
            thisYearValueEbay.Add(eBayGrandTotal);
            ...
            lastYearValueWeb.Add(preGrandTotal);
            ...
            lastYearValueEbay.Add(eBayPreGrandTotal);
        ...
        result.data.datasets.Add(new ChartSubItem
        {
            data = lastYearValueWeb,
            fillColor = "rgba(220,220,220,0.5)",
            strokeColor = "rgba(220,220,220,1)"
        });
        result.data.datasets.Add(new ChartSubItem
        {
            data = thisYearValueWeb,
            fillColor = "red",
            strokeColor = "rgba(151,187,205,1)"
        });
        result.data.datasets.Add(new ChartSubItem
        {
            data = lastYearValueEbay,
            fillColor = "rgba(220,220,220,0.5)",
            strokeColor = "rgba(220,220,220,1)"
        });
        result.data.datasets.Add(new ChartSubItem
        {
            data = thisYearValueEbay,
