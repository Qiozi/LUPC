<%@ Page Language="C#" MasterPageFile="~/Q_Admin/None.master" AutoEventWireup="true" CodeFile="product_part_move_or_copy.aspx.cs" Inherits="Q_Admin_product_part_move_or_copy" Title="Untitled Page" %>
        ...
        <table>
                <tr>
                        ...
                        <td><uc1:CategoryDropDownLoad ID="CategoryDropDownLoad1" runat="server" 
                            CFT="no_system" /></td>
                        <td>
                           priority <asp:TextBox ID="txt_priority" runat="server">0</asp:TextBox>
                        </td>
