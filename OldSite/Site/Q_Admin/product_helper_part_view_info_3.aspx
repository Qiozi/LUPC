...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" src="/q_admin/js_css/jquery-1.9.1.js"></script>
    <script type="text/javascript" src="/q_admin/js_css/jquery-ui-1.10.2.custom.min.js"></script>
    <link rel="stylesheet" href="/q_admin/js_css/ui-lightness/jquery-ui-1.10.2.custom.min.css" />
        ...
        function showTagImg() {
            ...
            $('span[title=eBayOnline]').each(function () {
                ...
                if ($(this).html() == "0")
                    ...
                    var sku = $(this).html();
                    $(this).html("<a href='http://www.ebay.ca/itm/ws/eBayISAPI.dll?ViewItem&Item=" + $(this).data('itemid') + "' target='_blank'><img src='/soft_img/app/ebay_logo.jpg'></a>");
                    //alert($(this).html());
                }
                $.get('/q_admin/manager/product/GetProdSpecificsStatus.aspx', { sku: sku }, function (data) {
                    _this.append("<span style='color:#fff;background-color:green; border:1px solid green;'>" + data + "</span>");
                });
            });
        }
