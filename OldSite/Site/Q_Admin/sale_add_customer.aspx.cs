...
public partial class Q_Admin_sale_add_customer : OrderPageBase
{
    ...
    {
        var ssm = StateShippingModel.GetModelsBySystemCategory(DBContext, country_id);
    ...
    {
        var cms = DBContext.tb_country.ToList();// CountryModel.FindAll();
    ...
    public void BindModifyCustomer(bool autoUpdate, int customer_id)
    {
        ...
        BindShippingStateDDL(model.customer_shipping_country.Value);
        try
        {
    ...
    protected void lb_new_Order_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                new CustomerHelper(DBContext).CopyCustomer(OrderCode, CurrentCustomerID);
