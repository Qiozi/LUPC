...
public partial class Q_Admin_NetCmd_SendEmailToBenson : System.Web.UI.Page
{
    ...
    public string GetEmailBody()
    {
        ...
        {
            string filename = string.Format("{0}{1}_comment.html", Config.Part_Comment_Path, issue_dt.Rows[i]["product_serial_no"].ToString()); //Server.MapPath(string.Format("/part_comment/{0}_comment.html", issue_dt.Rows[i]["product_serial_no"].ToString())).ToLower();
