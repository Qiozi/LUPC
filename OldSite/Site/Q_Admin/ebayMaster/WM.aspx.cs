...
public partial class Q_Admin_ebayMaster_WM : PageBase
{
    ...
    public static object GetShippingServiceValue(string categoryid)
    {
        try
        {
            ...
            var list = context.tb_ebay_shipping_settings.Where(me => me.CategoryID.Equals(me.CategoryID.Equals(categoryid))).ToList();//  EbayShippingSettingsModel.FindAllByProperty("CategoryID", categoryid.Trim());
