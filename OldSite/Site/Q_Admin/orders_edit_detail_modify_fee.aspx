...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <p>
        ...
        <table>
            <tr>
                <td align="right">Special Discount</td>
                <td>
                    <asp:TextBox runat="server"
                        ID="txt_special_discount" Columns="30" MaxLength="30"></asp:TextBox></td>
                <td colspan="2">
                    <anthem:CheckBox ID="CheckBox_lock_input_discount" runat="server"
                        Text="Lock Input" /></td>
                
            </tr>
            <tr>
                <td align="right">Ship Charge</td>
                <td>
                    <asp:TextBox runat="server" ID="txt_ship_charge"
                        Columns="30" MaxLength="30"></asp:TextBox></td>
                <td colspan="2">
                    <anthem:CheckBox ID="CheckBox_lock_input_ship_charge" runat="server"
                        Text="Lock Input" /></td>
            ...
            <tr>
                <td align="right" valign="top">Price Unit</td>
                <td>
            ...
            <tr>
                <td align="right" valign="top">Ship Method</td>
                <td>
