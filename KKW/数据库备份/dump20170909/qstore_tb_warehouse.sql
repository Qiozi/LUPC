...
CREATE TABLE `tb_warehouse` (
  ...
  `showit` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`)
...
INSERT INTO `tb_warehouse` VALUES (1,'公司仓库',1),(2,'显神仓库',0),(3,'亚马逊仓库',0),(4,'已打包',0),(5,'瑕疵品',0),(6,'暂存库',0),(7,'瑕疵品(已售)',0),(8,'中转（未分配）',1),(9,'云仓',1);
...
-- Dump completed on 2017-09-09 23:41:16
