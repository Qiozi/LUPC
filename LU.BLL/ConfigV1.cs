...
namespace LU.BLL
{
    ...
    {
        public static string CacheFilePath = System.Configuration.ConfigurationManager.AppSettings["CacheFilePath"].ToString();

        /// <summary>
        /// 系统自定义配置能显示的所有商品零件类ID
        /// </summary>
        public static List<int> SysCustomizePartAccessoriesCommentID = new List<int>() { 51, 50, 48, 47 };
        ...
        /// <summary>
        /// 信用卡手续费百分比 0.02, 2019年2月15， 改为0.035 与paypal手续费一至
        /// </summary>
        public static decimal CardRate { get { return 0.035M; } }
        ...
        public static string ImgHost = "https://www.lucomputers.com/";
